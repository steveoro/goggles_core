...
describe NewsFeed, type: :model do
  context '[class]' do
    it_behaves_like('(the existance of a class method)', [:create_social_feed, :create_social_approve_feed, :create_social_remove_feed, :create_achievement_feed, :create_achievement_approve_feed, :create_achievement_confirm_feed])
    #-- -----------------------------------------------------------------------
    #++
  ...
  context '[a well formed instance]' do
    ...
    # Filtering scopes:
    it_behaves_like('(the existance of a class method)', [:unread, :friend_activities, :only_achievements, :newsletter_activities, :sort_by_user])
  end
  #-- -------------------------------------------------------------------------
  #++
end
