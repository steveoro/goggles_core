...
describe Meeting, type: :model do
  ...
  context "[a well formed instance]" do
    ...
    context "[general methods]" do
      ...
      it_behaves_like( "(the existance of a method)", [
        :get_edition, :get_scheduled_date,
        :get_meeting_date, :get_scheduled_date_with_verbose_name,
        :get_season_type,
        :get_short_dates, :get_session_dates,

        :get_session_warm_up_times,
        :get_session_begin_times,
        :get_swimming_pool,
        :get_pool_type,
        :get_events_by_pool_types,
        :meeting_date_to_iso,
        :get_data_import_file_name
      ])
    end
