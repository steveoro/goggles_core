...
describe CategoryType, type: :model do
  ...
  describe '[a well formed instance]' do
    ...
    # Filtering scopes:
    it_behaves_like('(the existance of a class method)', [:is_valid, :only_relays, :are_not_relays])
    ...
    context '[general methods]' do
      it_behaves_like('(the existance of a method returning non-empty strings)', [:get_short_name, :get_full_name, :get_verbose_name])
