...
describe DataImportTeamAnalysisResult, type: :model do
  ...
  context '[Standard Factory]' do
    ...
    it_behaves_like('(belongs_to required models)',
                    [:data_import_session, :season, :team])

    it_behaves_like('(the existance of a method)',
                    [:analysis_log_text, :sql_text, :searched_team_name, :desired_season_id, :chosen_team_id, :team_match_name, :team_match_score, :best_match_name, :best_match_score, :is_a_perfect_match, :can_insert_alias, :can_insert_team, :can_insert_affiliation, :rebuild_sql_text, :to_s])
