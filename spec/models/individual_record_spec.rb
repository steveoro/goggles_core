...
describe IndividualRecord, type: :model do
  context '[a well formed instance]' do
    ...
    # Validated relations:
    it_behaves_like('(belongs_to required models)', [:pool_type, :event_type, :gender_type, :team, :season, :season_type, :federation_type, :meeting_individual_result, :record_type])

    # Filtering scopes:
    it_behaves_like('(the existance of a class method)', [:team_records, :seasonal_records, :for_team, :for_season_type, :for_federation, :for_federation_code])
