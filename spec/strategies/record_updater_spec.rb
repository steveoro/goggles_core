...
describe RecordUpdater, type: :strategy do
  ...
  context '[implemented methods]' do
    it_behaves_like('(the existance of a method)',
                    [:find_existing_record_for, :is_better, :scan_results_for_season_type_records, :scan_results_for_team_records, :force_update_for_team_records, :updated_records, :added_records])
  end
  #-- -------------------------------------------------------------------------
  #++
