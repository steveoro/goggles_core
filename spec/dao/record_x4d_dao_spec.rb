...
describe RecordX4dDAO, type: :model do
  ...
  context 'RecordElementDAO subclass,' do
    describe '[a well formed instance]' do
      ...
      it_behaves_like('(the existance of a method)', [:get_pool_type, :get_gender_type, :get_event_type, :get_category_type, :get_record_instance])

      it_behaves_like('(the existance of a method returning strings)', [:get_record_timing, :get_record_swimmer, :get_record_meeting])
  ...
  describe '[a well formed instance]' do
    it_behaves_like('(existance of a member array)', [:records, :gender_types, :pool_types, :category_types, :event_types])

    it_behaves_like('(the existance of a method)', [:add_record, :record_count, :has_record_for?, :get_record_instance, :get_record, :delete_record])
