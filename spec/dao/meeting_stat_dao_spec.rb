...
describe MeetingStatDAO, type: :model do
  ...
  before(:all) do
    @seeded_meets = [12_101, 12_102, 12_103, 12_104, 12_105, 13_101, 13_102, 13_103, 13_104, 13_105, 13_106]
  end

  let(:meeting) { Meeting.find_by(id: @seeded_meets.at((rand * @seeded_meets.size).to_i)) }
  ...
  context 'TeamMeetingStatDAO subclass,' do
    ...
    describe '[a well formed instance]' do
      ...
      it_behaves_like('(the existance of a method returning numeric values)', [:male_entries, :female_entries, :male_ent_swimmers, :female_ent_swimmers, :male_results, :female_results, :male_swimmers, :female_swimmers, :male_best, :female_best, :male_worst, :female_worst, :male_average, :female_average, :male_disqualifieds, :female_disqualifieds, :male_golds, :female_golds, :male_silvers, :female_silvers, :male_bronzes, :female_bronzes, :relay_results, :relay_disqualifieds, :relay_golds, :relay_silvers, :relay_bronzes])
    end
    #-- -------------------------------------------------------------------------
  ...
  context 'CategoryMeetingStatDAO subclass,' do
    ...
    describe '[a well formed instance]' do
      ...
      it_behaves_like('(the existance of a method returning numeric values)', [:male_ent_swimmers, :female_ent_swimmers, :male_swimmers, :female_swimmers])
    end
    #-- -------------------------------------------------------------------------
  ...
  context 'EventMeetingStatDAO subclass,' do
    ...
    describe '[a well formed instance]' do
      ...
      it_behaves_like('(the existance of a method returning numeric values)', [:male_entries, :female_entries, :male_results, :female_results])
    end
    #-- -------------------------------------------------------------------------
  ...
  describe '[a well formed instance]' do
    ...
    it_behaves_like('(existance of a member array of hashes)', [:teams, :categories, :events])
    ...
    describe '#get_general' do
      ...
      it 'returns a value if parameter corrisponding to a valid key' do
        ...
        expect(subject.generals.key?(valid_key)).to be true
