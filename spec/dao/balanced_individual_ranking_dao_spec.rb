...
describe BalancedIndividualRankingDAO, type: :model do
  ...
  context 'BIREventScoreDAO subclass,' do
    ...
    it_behaves_like('(the existance of a method)', [:event_date, :event_type, :rank, :event_points, :ranking_points, :get_total_points])

    describe '#initialize' do
      it 'uses the converted_time if given' do
        meeting_50 = Meeting.find(14_105)
  ...
  context 'BIRMeetingScoreDAO subclass,' do
    ...
    it_behaves_like('(the existance of a method)', [:header_date, :event_bonus_points, :medal_bonus_points, :event_points, :ranking_points, :event_results, :get_total_points])
  ...
  context 'as a valid instance,' do
    ...
    it_behaves_like('(the existance of a method)', [:season, :gender_and_categories, :meetings_with_results, :seasonal_event_bests, :get_ranking_for_gender_and_category, :scan_for_gender_and_category, :calculate_ranking, :set_ranking_for_gender_and_category])
