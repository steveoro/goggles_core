...
describe ChampionshipDAO, type: :model do
  ...
  context 'TeamScoreDAO subclass,' do
    ...
    it_behaves_like('(the existance of a method)', [:team, :meetings, :total_points, :add_meeting])
  ...
  context 'as a valid instance,' do
    ...
    it_behaves_like('(the existance of a method)', [:columns, :meetings, :team_scores])
