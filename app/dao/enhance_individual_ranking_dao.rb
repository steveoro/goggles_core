...
class EnhanceIndividualRankingDAO
  ...
  def initialize(season)
    raise ArgumentError, 'Enhance individual ranking needs a season' unless season&.instance_of?(Season)
  ...
  def get_html_ranking_description(tot_meetings = @total_meetings)
    ...
    'La classifica finale è calcolata considerando le #{best_meetings} migliori ' \
    'prove su #{tot_meetings}.<br>Per ogni prova vengono totalizzati i punti ' \
    'in base a:<ul><li>piazzamento</li><li>valore della prestazione rapportata ai ' \
    'record regionali</li><li>miglioramento personale</li><li>doppio podio nella ' \
    'manifestazione</li><li>premio gare impegnative</li></ul>'.html_safe
  end
  #-- -------------------------------------------------------------------------
  #++
